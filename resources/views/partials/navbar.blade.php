    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            <div class="flex items-center">
                <a href="/" class="text-2xl font-serif font-bold text-celestia-800">Celestia<span class="text-celestia-500">Smiles</span></a>
            </div>
            ...
            <div class="hidden md:flex space-x-8">
                ...
                <a href="{{ route('team') }}" class="text-gray-700 hover:text-celestia-600 transition">Team</a>
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ route('contact') }}" class="bg-celestia-600 text-white px-6 py-2 rounded-full hover:bg-celestia-700 transition">
                    Schedule a visit
                </a>
                @auth

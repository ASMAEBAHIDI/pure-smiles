            ...
            <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="long_description" rows="5" class="form-control @error('long_description') is-invalid @enderror"></textarea>
                        @error('long_description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">Prix min (DH)</label>
                        <input type="number" name="price_min" class="form-control @error('price_min') is-invalid @enderror" step="1">
                        @error('price_min') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">Prix max (DH)</label>
                        <input type="number" name="price_max" class="form-control @error('price_max') is-invalid @enderror" step="1">
